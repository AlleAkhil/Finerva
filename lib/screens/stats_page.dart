...
class _StatsPageState extends State<StatsPage> {
  int _selectedIndex = 3; // Set the initial selected index for the stats tab
    ...
    if (index != _selectedIndex) {
      ...
      switch (index) {
        ...
        case 2:
          ...
          break;
        case 3:
          AppNavigator.navigateTo('/stats'); // We're already on the stats page, no need to navigate
          break;
        case 4:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.bar_chart), // Changed the icon to statistics-related
          onPressed: () {
